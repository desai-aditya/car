# Makefile for 14642 lab 3
#
# differences from lab 2 Makefile:
# -- add directories and rules for USER_PROJ
...
$(U_OBJ_PROJ_DIR)/%.o: $(U_COMMON_SRC_DIR)/%.c
	@printf "\n$y$bCompiling: $<$n$n\n"
	python3 util/generate_argv.pyc $(U_COMMON_INC_DIR)/usr_arg.h $(USER_ARG)
